...
class InvitationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'POST invite with failing turnstile re-renders new' do
    ...
    # The inviter is signed in here, so check their session was not swapped.
  ...
  # so no Turnstile head tags are rendered on the accept page.
  test 'GET accept invitation has no turnstile head tags' do
